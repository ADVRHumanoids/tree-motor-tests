...
def process(yaml_file, plot_all=False):
    ...
    if 'test_type' in out_dict['test_velocity']:
        test_type = out_dict['test_velocity']['test_type']
    else:
        test_type = "ramp"
    ...
    image_base_path = new_head +f'{code_string}_test-velocity-free-{test_type}'

    log_file = head + f'{code_string}_test-velocity-free-{test_type}.log'
    ...
    if 'test_velocity' in out_dict:
        number_of_iters = out_dict['test_velocity']['number_of_iters']
        rise_time = out_dict['test_velocity']['rise_time']
        wait_time = out_dict['test_velocity']['wait_time']
        t_steps = [ns[0]/1e9]
        ...
        raise Exception("missing 'test_velocity' in yaml parsing")
